...
TRAIN_DIR=/wuwei/TF_classification/logs/wardrobe_cabinet_inception_v3

# Where the dataset is saved to.
DATASET_DIR=/wuwei/TF_classification/data/wardrobe_cabinet
